...
/**
 Your Informatics teacher at school likes
 coming up with new ways to help you understand the material.
 When you started studying numeral systems,
 he introduced his own numeral system, which he's
 convinced will help clarify things. His numeral system has base 26,
...
public class NewNumeralSystem {
    public NewNumeralSystem() {
        System.out.println(newNumeralSystem('G'));
    }

    String[] newNumeralSystem(char number) {
        int l = (int) number - 65;
        String[] array = new String[l/2 + 1];
        int i = 0;
        while (i <= l/2) {
            array[i] = (char) (i + 65) + " + " + (char) (number - i);
